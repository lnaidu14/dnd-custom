...
export default function HomeScreen({ onCreateCampaign, onJoinCampaign, onDeleteCampaign }) {
  ...
  return (
    <div className={`${styles.container} bg-background min-h-screen p-4 md:p-6`}>
      ...
      <div className={styles.tabNav}>
        <button 
          className={`${styles.tab} ${activeTab === 'dm' ? styles.activeTab : ''}`}
      ...
      {activeTab === 'player' && (
        <div className={styles.tabContent}>
          <div className={styles.instructions}>
            ...
            <p>Ask your DM for the campaign name, then click on it below to join:</p>
          </div>
